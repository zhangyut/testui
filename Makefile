...
EXTRALIBS_GUI = -L/Users/leizhang/src/brew/Cellar/libtiff/4.0.10_1/lib -ltiff -framework WebKit
WX_CPPFLAGS = -D_FILE_OFFSET_BITS=64 -I${wx_top_builddir}/lib/wx/include/osx_cocoa-unicode-3.1 -I${top_srcdir}/include 
WX_CXXFLAGS = -Wall -Wundef -Wunused-parameter -Wno-ctor-dtor-privacy -Woverloaded-virtual -Wno-deprecated-declarations -O2 -I/Users/leizhang/src/brew/Cellar/libtiff/4.0.10_1/include -fno-common  -fvisibility=hidden -fvisibility-inlines-hidden
WX_LDFLAGS =  -framework IOKit -framework Carbon -framework Cocoa -framework AudioToolbox -framework System -framework OpenGL 
HOST_SUFFIX = 
SAMPLES_RPATH_FLAG = 
SAMPLES_CXXFLAGS =  -dynamic -fPIC -DPIC
wx_top_builddir = /Users/leizhang/src/wxWidgets
...
TOOLBAR_CXXFLAGS = $(WX_CPPFLAGS) -D__WX$(TOOLKIT)__ $(__WXUNIV_DEFINE_p) \
...
COND_PLATFORM_OS2_1___toolbar___os2_emxbindcmd = $(NM) toolbar$(EXEEXT) | if \
	grep -q pmwin.763 ; then emxbind -ep toolbar$(EXEEXT) ; fi
#__toolbar___os2_emxbindcmd = $(COND_PLATFORM_OS2_1___toolbar___os2_emxbindcmd)
#__RCDEFDIR_p = --include-dir \
#	$(LIBDIRNAME)/wx/include/$(TOOLCHAIN_FULLNAME)
__toolbar_app_Contents_PkgInfo___depname \
	= toolbar.app/Contents/PkgInfo
__toolbar_bundle___depname = toolbar_bundle
...
#__toolbar___win32rc = toolbar_toolbar_rc.o
...
all: testui$(EXEEXT) $(__toolbar_bundle___depname)
...
testui$(EXEEXT): $(TOOLBAR_OBJECTS) $(__toolbar___win32rc)
	$(CXX) -o $@ $(TOOLBAR_OBJECTS)    -L$(LIBDIRNAME)  $(LDFLAGS_GUI) $(SAMPLES_RPATH_FLAG) $(LDFLAGS)  $(WX_LDFLAGS) $(__WXLIB_CORE_p)  $(__WXLIB_BASE_p)  $(__WXLIB_MONO_p) $(__LIB_SCINTILLA_IF_MONO_p) $(__LIB_TIFF_p) $(__LIB_JPEG_p) $(__LIB_PNG_p)  $(EXTRALIBS_FOR_GUI) $(__LIB_ZLIB_p) $(__LIB_REGEX_p) $(__LIB_EXPAT_p) $(EXTRALIBS_FOR_BASE) $(LIBS)
	$(__toolbar___os2_emxbindcmd)

toolbar.app/Contents/PkgInfo: toolbar$(EXEEXT) $(top_srcdir)/src/osx/carbon/Info.plist.in $(top_srcdir)/src/osx/carbon/wxmac.icns
	...
	$(top_srcdir)/src/osx/carbon/Info.plist.in >toolbar.app/Contents/Info.plist
	
	
	/bin/echo "APPL????" >toolbar.app/Contents/PkgInfo
	
	
	ln -f toolbar$(EXEEXT) toolbar.app/Contents/MacOS/toolbar
	
	
	cp -f $(top_srcdir)/src/osx/carbon/wxmac.icns toolbar.app/Contents/Resources/wxmac.icns
